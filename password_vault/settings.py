...
import os
try:
    # dotenv is optional in some environments; if it's not installed, skip loading .env
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'vault_auth.apps.VaultAuthConfig',
    'django_extensions',
]
...
# Custom User Model
AUTH_USER_MODEL = 'vault_auth.User'
